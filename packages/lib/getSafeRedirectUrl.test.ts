...
vi.mock("./constants", () => ({
  WEBAPP_URL: "https://app.rondevu.com.tr",
...
describe("isSafeUrlToLoadResourceFrom", () => {
  ...
  it("should return true for URLs with same TLD+1 as WEBAPP_URL", () => {
    expect(isSafeUrlToLoadResourceFrom("https://acme.rondevu.com.tr/path")).toBe(true);
    expect(isSafeUrlToLoadResourceFrom("http://dunder.rondevu.com.tr?query=1")).toBe(true);
    expect(isSafeUrlToLoadResourceFrom("https://rondevu.com.tr/path")).toBe(true);
  });
